		...
		scaleVertexes3D(
			(function () {
				const C0 =
					...
					C1 =
						Math.sqrt(
							2 * (Math.sqrt(5) - 1 - 2 * Math.sqrt(Math.sqrt(5) - 2))
						) / 4,
					C2 = Math.sqrt(2 * (2 - Math.sqrt(2 * (Math.sqrt(5) - 1)))) / 4,
					C3 =
						Math.sqrt(
							2 * (3 - Math.sqrt(5) + Math.sqrt(2 * (5 * Math.sqrt(5) - 11)))
						) / 4,
					C4 = Math.sqrt((3 - Math.sqrt(5)) / 4),
					C5 =
						Math.sqrt(
							2 * (Math.sqrt(5) - 1 + 2 * Math.sqrt(Math.sqrt(5) - 2))
						) / 4,
					C6 = Math.sqrt((Math.sqrt(5) - 1) / 4),
					C7 = Math.sqrt(2 * (2 + Math.sqrt(2 * (Math.sqrt(5) - 1)))) / 4;
